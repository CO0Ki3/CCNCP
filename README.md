...
|------|--------|------|-------|-------|--------|-----|----|
| 검증 OOS (2021~2026) | 101 | 58.4% | +5.0% | **+79.6%** | 2.42 | -37.0% | 1.83 |
...
| TripleRise | 5.4 | — | — | — | — | — |
| **v2 조합** | **21.8** | **58.4%** | — | **2.42** | **-37.0%** | **1.83** |

### v3/v4 탐색 결과 (2026-05-25 확정)

| 후보 패턴 | 결정 | 근거 |
|---------|------|------|
| LowerTailBreak | ❌ 기각 | v2 파라미터 OOS PF 1.20, Sharpe 0.78 |
| CloseDominanceLoose | ❌ 기각 | v2 파라미터 OOS PF 1.45 (기준 1.5 미달) |
| CloseDominance (strict) | ⚠ 보류 | OOS Sharpe 3.41 우수, 단 19건 통계 한계 — 다중자산 검증 후 재검토 |

> **월 30% 목표 재설정:** 1일봉 Long only 구조에서 구조적 달성 불가 (NCP2 확정).  
> v2 연 복리 +79.6%는 이미 세계 최고 수준의 성과. 목표: **연 60~100% 복리**로 재설정.
