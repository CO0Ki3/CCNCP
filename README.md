...
| Phase 8 | 탐색 공간 확대 (조건 3개) 및 검정력 규명 | ✅ 완료 — **합격 0건, 신호는 실재** |

> **현재 상태 (2026-08-02):** 확정 전략 없음.
> - 확정 패턴 4종은 30개 자산 검증에서 전부 기각 (FDR 5% 생존 0건)
> - 신규 후보 **316만 개** 전수 탐색에서 Bonferroni 통과 0건
> - 다만 경험적 귀무 대조 결과 **캔들 기하에 약한 신호는 실재한다** — 실제 데이터의
>   1단 통과율이 귀무의 2.4배, 최소 p가 절반(0.073 vs 0.146), Mann-Whitney p=5.2e-07
> - 그 신호는 **이 설계로 인증하기엔 3~5배 작고, 거래비용 차감 후 단순 보유를 못 이긴다**
>
